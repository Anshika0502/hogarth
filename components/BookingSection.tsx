          ...
          <div className="relative z-10">
            {isSubmitted ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full py-5 rounded-xl bg-[#D4AF37] text-[#0a0a0a] text-[18px] font-bold transition-all duration-300 hover:bg-[#f0c44a] hover:shadow-[0_0_40px_rgba(212,175,55,0.4)] hover:scale-[1.02] flex items-center justify-center gap-3 group animate-slide-up"
