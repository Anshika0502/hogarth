...
if (appliedFrom || appliedTo) {
  ...
  return (
    <div className="min-h-screen bg-gold-dust text-white  flex flex-col lg:flex-row">
      {/* Sidebar */}
      <div className="
    w-[56px] sm:w-24   
  ...
  ">
        ...
        <nav className="p-2 sm:p-4">
          <button
            ...
            className={`w-full flex items-center gap-3  p-2 sm:px-4 sm:py-3  
rounded-lg mb-3 transition-all ${
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-3 sm:px-4 rounded-lg transition-all ${
      ...
      {/* Main Content */}
      <div className="flex-1 ml-14 sm:ml-24 min-w-0 overflow-x-hidden ">
        {activeSection === 'dashboard' ? (
          <>
            {/* Header */}
 ...
 border-b border-white/40 px-8 py-4 flex items-center justify-between">
              <h1 className="text-[40px] sm:text-[48px] mt-0 tracking-wider" style={{ fontFamily: 'Bebas Neue, Impact, sans-serif' }}>
                ADMIN DASHBOARD
                <p className="text-gray-400 mt-2">Manage bookings and monitor club activity</p>
              </h1>
            </div>

            <div className="max-w-[395px]  sm:max-w-[1440px] sm:mx-auto sm:px-4 md:px-8 py-8 px-2">
              {/* Stats Cards */}
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 mb-8 ">
                <div className="bg-gradient-to-br from-white/[0.06] to-white/[0.02]
 shadow-[0_10px_50px_rgba(0,0,0,0.6)] rounded-xl p-6 border border-white/40
 hover:border-[#d3b03c] transition-all ">
                ...
                <div className="bg-gradient-to-br from-white/[0.06] to-white/[0.02]
 shadow-[0_10px_50px_rgba(0,0,0,0.6)] rounded-xl p-6 border border-white/40
 border hover:border-[white] transition-all ">
                  <div className="flex items-center justify-between mb-4">
                ...
                <div className="bg-gradient-to-br from-white/[0.06] to-white/[0.02]
 shadow-[0_10px_50px_rgba(0,0,0,0.6)] rounded-xl p-6 border border-white/40
  hover:border-[#10B981] transition-all ">
                  <div className="flex items-center justify-between mb-4">
                ...
                <div className="bg-gradient-to-br from-white/[0.06] to-white/[0.02]
 shadow-[0_10px_50px_rgba(0,0,0,0.6)] rounded-xl p-6 border border-white/40 hover:border-[#EF4444] transition-all ">
                  <div className="flex items-center justify-between mb-4">
 ...
 shadow-[0_10px_50px_rgba(0,0,0,0.6)] rounded-xl p-6 border border-white/40 border mb-6 max-w-7xl">
              ...
              {/* Reservations Table */}
              <div className="bg-gradient-to-br from-white/[0.06] to-white/[0.02]
 shadow-[0_10px_50px_rgba(0,0,0,0.6)] rounded-xl border border-white/40 border overflow-hidden sm:max-w-7xl overflow-x-auto">
                <div className="p-2 pt-6 pl-4 sm:p-4 sm:pl-8 border-b   border-white/40 border sm:flex sm:items-center sm:justify-between">
                  <h2 className="text-[20px] sm:text-[32px] m-0" style={{ fontFamily: 'Bebas Neue, Impact, sans-serif', letterSpacing: '2px' }}>
                    BOOKINGS
                  </h2>
                  <div className="sm:flex items-center sm:mr-10">
                    <th className="sm:px-3 py-2">
                  <div className="flex flex-col ">
                    <label className="text-md text-gray-400 mr-24 sm:mr-28">From:</label>
                    <input
                    type="date"
                    value={fromDate || ""}
                 ...
                 <th className="px-3 py-2">
                   <div className="flex flex-col">
                    ...
                    className="px-4 py-1 sm:ml-4 mt-3 mb-3 sm:mb-0 sm:mt-4 w-80 sm:w-auto bg-[#D4AF37] text-black rounded-lg font-semibold hover:bg-[#c9a32f]"
                  >
                    Apply
                  </button>
...
">
                      <tr>
                        <th className="sm:px-8 px-3 pt-0 text-left uppercase text-[12px] sm:text-[14px] tracking-wider">
                          Customer
                        </th>
                        <th className="sm:px-8 pl-9 pt-4 text-left uppercase text-[12px] sm:text-[14px] tracking-wider">
                          Service
                          ...
                          <div className="relative mt-2 mb-2 ">
                            <select
                              ...
                              className="bg-[rgba(212,175,55,0.08)] border border-[#D4AF37]/30
                                             ...
                                             hover:border-[#D4AF37] transition w-28 sm:w-[160px]"
                            >
                        ...
                        <th className="hidden sm:table-cell px-6 text-left uppercase text-[14px]">
                          Date & Time
                        </th>
                        <th className="hidden sm:table-cell px-6 text-left uppercase text-[14px]">
                          Status
                        </th>
                        <th className="px-6  text-left uppercase text-[12px] sm:text-[14px]">
                          Actions
                        </th>
                      </tr>
                    </thead>
                     ...
                     {isLoading ? (
                       ...
                       <tr>
                        ...
                        filteredReservations.map((reservation) => (
                          ...
                          >
                            <td className="px-2 sm:px-6 py-4 max-w-[100px] sm:max-w-none">
                              <div className="flex items-center gap-3 max-w-full">
                                <div className="w-6 sm:w-10 h-7 sm:h-10 rounded-full bg-[#D4AF37]/20 flex items-center justify-center">
                                  <User size={20} style={{ color: '#D4AF37' }} />
                                </div>
                                <div>
                                  <div className="font-medium">{reservation.name}</div>
                                  <div className="text-gray-400  text-[12px] sm:text-[14px] flex items-center gap-1 line-clamp-2 break-all">
                                    <Mail size={12} />
                                    {reservation.email}
                                  </div>
                                  <div className="text-gray-400  text-[12px] sm:text-[14px] flex items-center gap-1 mt-1">
                                   <Phone size={12} />
                                   {reservation.phone}
                                   </div>
                                </div>
                            ...
                            <td className=" sm:px-6 py-4">
                              <span className= " sm:px-2 px-1 ml-8 py-1  bg-[#2E7D32]/20 text-[#A8D5BA] rounded-full text-[14px]">
                                {reservation.service}
                              </span>
                            </td>
                            ...
                            <td className="sm:px-6 px-4 py-4 pt-8 sm:pt-4 align-top">
                                ...
                                {reservation.status === "pending" && (
                                  <>
                                    <button
                                      ...
                                      className="flex items-center justify-center sm:gap-2 gap-1 sm:px-4 px-1 py-2 text-[14px] sm:text-[16px] 
